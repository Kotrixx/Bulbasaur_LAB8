                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a  class="btn-ingresar" href="<%=request.getContextPath()%>/MainServlet?action=edit&id=<%=viaje.getIdViaje()%>"> Editar viaje </a>
                                <a class="btn-ingresar"href="<%=request.getContextPath()%>/MainServlet?action=del&id=<%=viaje.getIdViaje()%>"> Eliminar viaje </a>
                            </div>
                        </div>
                    </div>
                </div>
